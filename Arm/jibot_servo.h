...
/**
 * @brief 将四轴位置命令打包为一条 Jibot 组命令并发送。
 *
 * 发送格式为 `{G0000#000PppppTtttt!#001PppppTtttt!#002PppppTtttt!#003PppppTtttt!}`。
 * S4/S5 已移除，组命令只包含 S0~S3，适用于一帧四轴同步动作。
 *
 * @param position_pwm 四个舵机 ID 0~3 的目标 PWM，均须在 500~2500。
